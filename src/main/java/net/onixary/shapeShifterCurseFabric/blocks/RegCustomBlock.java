...
public final class RegCustomBlock {
    ...
    public static final Block WEB_COMPOSTER = register("web_composter", new WebComposterBlock(AbstractBlock.Settings.create().mapColor(MapColor.DARK_GREEN).strength(0.6F).sounds(BlockSoundGroup.AZALEA).nonOpaque()));
