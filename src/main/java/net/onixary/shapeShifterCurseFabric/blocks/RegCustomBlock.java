...
public final class RegCustomBlock {
    ...
    // public static final Block WEB_COMPOSTER = ...; // WebComposterBlock disabled for 1.21 port
    ...
    public static void ClientInit() {
        ...
        // BlockRenderLayerMap.INSTANCE.putBlock(WEB_COMPOSTER, RenderLayer.getCutout()); // Disabled for 1.21 port
