...
public class RegPlayerAnimation {
    ...
    /*public static void playTestAnimation() {
        ...
        testAnimation = (ModifierLayer<IAnimation>) PlayerAnimationAccess.getPlayerAssociatedData(MinecraftClient.getInstance().player).get(Identifier.of(MOD_ID, "player_animation"));
        ...
        if (testAnimation.getAnimation() != null && new Random().nextBoolean()) {
            ...
            testAnimation.replaceAnimationWithFade(AbstractFadeModifier.functionalFadeIn(20, (modelName, type, value) -> value),
                    new KeyframeAnimationPlayer(PlayerAnimationRegistry.getAnimation(Identifier.of(MOD_ID, "two_handed_slash_vertical_right")))
