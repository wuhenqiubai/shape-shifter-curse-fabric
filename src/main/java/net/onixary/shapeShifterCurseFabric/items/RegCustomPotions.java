...
public class RegCustomPotions {
    ...
    public static final Potion FEED_POTION =
            Registry.register(Registries.POTION, Identifier.of(MOD_ID, "feed_potion"),
