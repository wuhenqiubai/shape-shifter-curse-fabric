...
| 🚧 | 部分 Power | VirtualTotemPower (readItemStack→ItemStack.PACKET_CODEC 待迁移) |
| 🚧 | Player Form Render | AzureLib 3.x 渲染管线 + SkinTextures + player_form_render 适配 |

> **编译状态**: ~30 unique errors，集中在 player_form_render/AzureLib/mixin
