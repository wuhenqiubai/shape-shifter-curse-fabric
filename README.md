...
## 使用本非官方移植版Mod时，请不要向onixary官方的GitHub库提交Issue，提交Issue也请发送报错报告等信息，不要只发报错图片
...
>
> **基于上游commit移植
**: [8d3a4050](https://github.com/wuhenqiubai/shape-shifter-curse-fabric/commit/8d3a40505c43d77dce8bb9511be19fed224c4055)
...
>
> **运行时状态**: ⚠️ 核心功能基本恢复，少数 UI/渲染问题待修复
...
- **不保证持续维护**：此移植可能不会跟进上游更新或修复所有已知问题，并且本开发者为高中生，活跃时间不固定
...
> 移植工具链: Claude Code (deepseek-v4-flash/pro), Fabric Loom 1.9, Yarn mappings 1.21.1+build.3
>
> **移植版下载**: 请从 [GitHub Releases](https://github.com/wuhenqiubai/shape-shifter-curse-fabric/releases) 页面查找 `1.21.1`
> 标签的版本
