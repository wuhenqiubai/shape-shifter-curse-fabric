...
| 类别 | 文件数 | 说明 |
|------|--------|------|
| 🔴 Advancement 触发条件 | 17 个文件 | `PowerType<?>` 泛型、`AbstractCriterion` 1.21.1 改名 |
| 🟡 Origins 旧 API 残留 | 8 个文件 | `PowerTypeRegistry`、`ConditionTypes`、Badge 相关 |
| 🟠 Satin 2.0 API 变更 | 1 个文件 | `ShaderEffectRenderCallback` 等包路径更新 |
| 🟢 Minecraft 1.21.1 API 变更 | 散落各处 | `FabricItemSettings`、`Instrument` 等 |
